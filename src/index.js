...
function fn_tag() {
  //Station 1
  io.emit("btt_Auto", arr_tag_value[0]);
  io.emit("btt_Manu", arr_tag_value[1]);
  io.emit("btt_Auto_Confirm", arr_tag_value[2]);
  io.emit("btt_V1_Open", arr_tag_value[3]);
  io.emit("btt_V1_Close", arr_tag_value[4]);
  io.emit("btt_V2_Open", arr_tag_value[5]);
  io.emit("btt_V2_Close", arr_tag_value[6]);
  io.emit("btt_V3_Open", arr_tag_value[7]);
  io.emit("btt_V3_Close", arr_tag_value[8]);
  io.emit("btt_DC_Tron_Run", arr_tag_value[9]);
  io.emit("btt_DC_Tron_Stop", arr_tag_value[10]);
  io.emit("btt_DC_Export_Run", arr_tag_value[11]);
  io.emit("btt_DC_Export_Stop", arr_tag_value[12]);
  io.emit("CB_Can", arr_tag_value[13]);
  io.emit("Q_Lamp_Auto", arr_tag_value[14]);
  io.emit("Q_Lamp_Manu", arr_tag_value[15]);
  io.emit("status_Valve_1", arr_tag_value[16]);
  io.emit("status_Valve_2", arr_tag_value[17]);
  io.emit("status_Valve_3", arr_tag_value[18]);
  io.emit("status_DC_Tron", arr_tag_value[19]);
  io.emit("status_DC_Export", arr_tag_value[20]);
  io.emit("Setting_Time_Tron", arr_tag_value[21]);
  io.emit("Act_Time_Tron", arr_tag_value[22]);
  io.emit("Setting_Weight_1", arr_tag_value[23]);
  io.emit("Setting_Weight_2", arr_tag_value[24]);
  io.emit("Setting_Weight_3", arr_tag_value[25]);
  io.emit("Act_Weight_1", arr_tag_value[26]);
  io.emit("Act_Weight_2", arr_tag_value[27]);
  io.emit("Act_Weight_3", arr_tag_value[28]);
  io.emit("sql_insert_Trigger", arr_tag_value[29]);
  io.emit("sql_insert_On", arr_tag_value[30]);
  io.emit("sql_insert_Off", arr_tag_value[31]);
  io.emit("sql_insert_Temp", arr_tag_value[32]);
  io.emit("sql_delete_Trigger", arr_tag_value[33]);
  io.emit("sql_OrderID", arr_tag_value[34]);
  io.emit("sql_Weight1_Setting", arr_tag_value[35]);
  io.emit("sql_Weight2_Setting", arr_tag_value[36]);
  io.emit("sql_Weight3_Setting", arr_tag_value[37]);
  io.emit("sql_Weight1_Actual", arr_tag_value[38]);
  io.emit("sql_Weight2_Actual", arr_tag_value[39]);
  io.emit("sql_Weight3_Actual", arr_tag_value[40]);
  io.emit("sql_Time_Tron_Setting", arr_tag_value[41]);
  io.emit("sql_Time_Tron_Actual", arr_tag_value[42]);
  io.emit("on_System", arr_tag_value[43]);
  io.emit("off_System", arr_tag_value[44]);
  io.emit("Alarm_M1", arr_tag_value[45]);
  io.emit("Alarm_M2", arr_tag_value[46]);
  ...
  io.emit("btt_Auto_Confirm_s2", arr_tag_value_s2[2]);
  io.emit("btt_V1_Open_s2", arr_tag_value_s2[3]);
  io.emit("btt_V1_Close_s2", arr_tag_value_s2[4]);
  io.emit("btt_V2_Open_s2", arr_tag_value_s2[5]);
  io.emit("btt_V2_Close_s2", arr_tag_value_s2[6]);
  io.emit("btt_V3_Open_s2", arr_tag_value_s2[7]);
  io.emit("btt_V3_Close_s2", arr_tag_value_s2[8]);
  io.emit("btt_DC_Tron_Run_s2", arr_tag_value_s2[9]);
  io.emit("btt_DC_Tron_Stop_s2", arr_tag_value_s2[10]);
  io.emit("btt_DC_Export_Run_s2", arr_tag_value_s2[11]);
  io.emit("btt_DC_Export_Stop_s2", arr_tag_value_s2[12]);
  io.emit("CB_Can_s2", arr_tag_value_s2[13]);
  io.emit("Q_Lamp_Auto_s2", arr_tag_value_s2[14]);
  io.emit("Q_Lamp_Manu_s2", arr_tag_value_s2[15]);
  io.emit("status_Valve_1_s2", arr_tag_value_s2[16]);
  io.emit("status_Valve_2_s2", arr_tag_value_s2[17]);
  io.emit("status_Valve_3_s2", arr_tag_value_s2[18]);
  io.emit("status_DC_Tron_s2", arr_tag_value_s2[19]);
  io.emit("status_DC_Export_s2", arr_tag_value_s2[20]);
  io.emit("Setting_Time_Tron_s2", arr_tag_value_s2[21]);
  io.emit("Act_Time_Tron_s2", arr_tag_value_s2[22]);
  io.emit("Setting_Weight_1_s2", arr_tag_value_s2[23]);
  io.emit("Setting_Weight_2_s2", arr_tag_value_s2[24]);
  io.emit("Setting_Weight_3_s2", arr_tag_value_s2[25]);
  io.emit("Act_Weight_1_s2", arr_tag_value_s2[26]);
  io.emit("Act_Weight_2_s2", arr_tag_value_s2[27]);
  io.emit("Act_Weight_3_s2", arr_tag_value_s2[28]);
  io.emit("sql_insert_Trigger_s2", arr_tag_value_s2[29]);
  io.emit("sql_insert_On_s2", arr_tag_value_s2[30]);
  io.emit("sql_insert_Off_s2", arr_tag_value_s2[31]);
  io.emit("sql_insert_Temp_s2", arr_tag_value_s2[32]);
  io.emit("sql_delete_Trigger_s2", arr_tag_value_s2[33]);
  io.emit("sql_OrderID_s2", arr_tag_value_s2[34]);
  io.emit("sql_Weight1_Setting_s2", arr_tag_value_s2[35]);
  io.emit("sql_Weight2_Setting_s2", arr_tag_value_s2[36]);
  io.emit("sql_Weight3_Setting_s2", arr_tag_value_s2[37]);
  io.emit("sql_Weight1_Actual_s2", arr_tag_value_s2[38]);
  io.emit("sql_Weight2_Actual_s2", arr_tag_value_s2[39]);
  io.emit("sql_Weight3_Actual_s2", arr_tag_value_s2[40]);
  io.emit("sql_Time_Tron_Setting_s2", arr_tag_value_s2[41]);
  io.emit("sql_Time_Tron_Actual_s2", arr_tag_value_s2[42]);
  io.emit("on_System_s2", arr_tag_value[43]);
  io.emit("off_System_s2", arr_tag_value[44]);
  io.emit("Alarm_M1_s2", arr_tag_value_s2[45]);
  io.emit("Alarm_M2_s2", arr_tag_value_s2[46]);
...
io.on("connection", function (socket) {
  ...
  fn_UserSearchGeneric("msg_user_Show","TABLE_ACCOUNT",sqlaccount,"user_Show");
});
...
function fn_sql_insert_mass() {
  insert_trigger = arr_tag_value[2]; // Read trigger from PLC
...
function fn_sql_insert_mass_s2() {
  insert_trigger_s2 = arr_tag_value_s2[2]; // Read trigger from PLC
...
function fn_Alarm_Manage() {
  ...
  // Cảnh báo van 1
  if ((Alarm_ID1 == true) & (Alarm_ID1 != Alarm_ID1_old)) {
  ...
  // Cảnh báo van 2
  if ((Alarm_ID2 == true) & (Alarm_ID2 != Alarm_ID2_old)) {
  ...
  // Cảnh báo van 3
  if ((Alarm_ID3 == true) & (Alarm_ID3 != Alarm_ID3_old)) {
  ...
  if ((Alarm_ID4 == true) & (Alarm_ID4 != Alarm_ID4_old)) {
  ...
  if ((Alarm_ID5 == true) & (Alarm_ID5 != Alarm_ID5_old)) {
...
function fn_Alarm_Manage_s2() {
  ...
  // Cảnh báo van 1
  if ((Alarm_ID1_s2 == true) & (Alarm_ID1_s2 != Alarm_ID1_old_s2)) {
  ...
  // Cảnh báo van 2
  if ((Alarm_ID2_s2 == true) & (Alarm_ID2_s2 != Alarm_ID2_old_s2)) {
  ...
  // Cảnh báo van 3
  if ((Alarm_ID3_s2 == true) & (Alarm_ID3_s2 != Alarm_ID3_old_s2)) {
  ...
  // Cảnh báo Động cơ trộn
  if ((Alarm_ID4_s2 == true) & (Alarm_ID4_s2 != Alarm_ID4_old_s2)) {
  ...
  // Cảnh báo máy xuất hàng
  if ((Alarm_ID5_s2 == true) & (Alarm_ID5_s2 != Alarm_ID5_old_s2)) {
...
function fn_UserSearchGeneric(msg_communicate_SQL,TABLE_ACCOUNT,sqlConnection,msg_Show){
  io.on("connection", function (socket) {
    socket.on(msg_communicate_SQL, function (data) {
      var sqltable_Name = process.env[TABLE_ACCOUNT];
      var query = "SELECT * FROM " + sqltable_Name + ";";
      sqlConnection.query(query, function (err, results, fields) {
        if (err) {
          console.log(err);
